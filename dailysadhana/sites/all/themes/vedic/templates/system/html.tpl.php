...
<body<?php print $attributes;?>>
  <div class="bg-slider">
    <!-- <div class="bg-slide" style="background-image: url('https://d4mg7m5aeu7n2.cloudfront.net/userfiles/files/page-images/body-bg.jpg')"></div> -->
  </div>
  <div class="container eclipse"></div>
